\chapter{Quantum Dot Characterization via Paraview}
...
\section{Charge Density Distribution and Potential Map}
...
The resulting graph in Figure \ref{fig:potential_plot} confirms the formation of the double quantum dot. However, \textbf{contrary to our observations in previous laboratory sessions}, the central potential barrier between the two dots appears significantly \textbf{more intense} or comparable to the outer confinement barriers. This behavior suggests a stronger decoupling between the two quantum dots in this specific configuration, potentially due to the different gate biasing or the specific geometry of the SiMOS device under investigation.
